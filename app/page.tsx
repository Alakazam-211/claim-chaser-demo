                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                      ...
                      <p className="text-dark font-medium">{claim.date_of_service ? formatDate(claim.date_of_service) : 'N/A'}</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-dark/70 mb-1">
                        Date of Birth
                      </label>
                      <p className="text-dark font-medium">{claim.date_of_birth ? formatDate(claim.date_of_birth) : 'N/A'}</p>
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-dark/70 mb-1">
                        Billed Amount
